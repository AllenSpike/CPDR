...
```
## Additional data
By default, CPDR uses LINCS_978 from octad.db. To get reliable results, users can download the LINCS_all_processed data manually from https://zenodo.org/record/5880026#.YgZos9--uUl.

## Example
The vignette shows the usecase of screening effective compounds targeting inidividual patient with colorectal cancer.
